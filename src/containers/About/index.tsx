...
import hero2 from 'assets/illustrations/hero2.svg';
...
export function About() {
  return (
    <main className="flex flex-col items-center gap-[24px]">
      <Hero
        backgroundImage={hero2}
        label=""
        className="h-[111px] md:h-[223px] w-full"
      />
      <div className="md:w-11/12 w-full flex flex-col gap-[24px]">
        <Drawer
          label="Fiabilité"
